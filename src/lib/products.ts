...
export const products: Product[] = [
  ...
  { id: "melon-galia", name: "Πεπόνι Γκάλια", category: "Φρούτα", price: 1.6, unit: "κιλό", emoji: "🍈", description: "Γλυκό πεπόνι Γκάλια με πράσινη σάρκα." },
  { id: "melon-cantaloupe", name: "Πεπόνι Καντελούπ", category: "Φρούτα", price: 1.8, unit: "κιλό", emoji: "🍈", description: "Πορτοκαλί σάρκα, έντονο άρωμα." },
  { id: "melon-honeydew", name: "Πεπόνι Honeydew", category: "Φρούτα", price: 1.7, unit: "κιλό", emoji: "🍈", description: "Λεία φλούδα, μέλι-γλυκό." },
  { id: "melon-piel-de-sapo", name: "Πεπόνι Piel de Sapo", category: "Φρούτα", price: 1.9, unit: "κιλό", emoji: "🍈", description: "Ισπανικό πεπόνι, τραγανή σάρκα." },
  { id: "melon-argos", name: "Πεπόνι Άργους", category: "Φρούτα", price: 1.5, unit: "κιλό", emoji: "🍈", description: "Παραδοσιακό ελληνικό πεπόνι." },
  { id: "melon-thrace", name: "Πεπόνι Θράκης", category: "Φρούτα", price: 1.6, unit: "κιλό", emoji: "🍈", description: "Αρωματικό πεπόνι από Θράκη." },
